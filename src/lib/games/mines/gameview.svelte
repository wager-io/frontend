...
import { mine_history,HandleSelectedMine, minesStore, HandlemineGems,HandleMineCount, Cashout , HandleHas_won,betDetails, HandleIsAlive, HandleWinning} from "./store/index"
