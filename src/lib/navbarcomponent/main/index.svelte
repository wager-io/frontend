        ...
        <div class="sc-fmciRz LQlWw">
            <button on:click={()=> isCoinDrop =! isCoinDrop} class="sc-iFMAIt icGouR">
                <div class="sc-eXlEPa boxpOO">
                    <img style="border-radius: 50%;" class="coin-icon" alt="" src={$handleisLoggin && $default_Wallet.coin_image}>
                ...
                <div class="sc-Galmp erPQzq coin notranslate balance">
                    <div class="amount">
                        <span class="amount-str">
                            {(parseFloat($default_Wallet.balance)).toFixed(6)}<span class="suffix">00</span>
                        </span>
                    </div>
                </div>
            </button>
    ...
    <div class="sc-gnnDb fWkueO">
        <div class="user-wrap">
            ...
            <button on:mouseenter={handleUserProfile} on:mouseleave={handleUserProfile} class ="svg">
                <span class="na-menu"><Icon src={CgMenuCheese}  size="18"   color="rgba(153, 164, 176, 0.6)"  /></span>
                {#if userProfile}
                    <Navprofile />
                {/if}
            </button>
    ...
    <button  id="notice" class="sc-ksHpcM kultDa notice">
        <div class="notice-btn ">
            <span class="na-notification">
                <Icon src={IoNotifications}  size="18"   color="rgba(153, 164, 176, 0.6)"  />
            </span>
        </div>
    </button>
    <button on:click={handleChat} id="chat" class="sc-eicpiI PGOpB">
        <div class="chat-btn ">
             <Icon src={BsDroplet}  size="28"   color="#fff"  />
...
<div class="sc-DtmNo euzHLF right">
    ...
    <div class="sc-gnnDb fWkueO">
        <div class="user-wrap">
            {#if $profileStore}
            <a href={`/`}>
                <img class="avatar" alt="" src="https://res.cloudinary.com/dxwhz3r81/image/upload/v1698011384/type_1_w_hqvuex.png">
            </a>
            {:else}
                <div class="center">
                    <div class="wave"></div>
    ...
    <button on:click={()=> goto("/chat")} class="sc-dcgwPl bbYXSv private-chat">
        <span class="nav-message">
            <Icon src={BsChatLeftDotsFill}  size="18"   color="rgba(153, 164, 176, 0.6)"  />
        </span>
    </button>
    <button  id="notice" class="sc-ksHpcM kultDa notice">
        <div class="notice-btn ">
    ...
    <div class="sc-gjNHFA jlttqa wallet-enter">
        <div class="sc-fmciRz LQlWw">
            ...
            <div class="sc-gnnDb fhlUmF">
                <div class="user-wrap">
                    <a  href={`/`}>
                        <img class="avatar " alt="" src="https://res.cloudinary.com/dxwhz3r81/image/upload/v1698011384/type_1_w_hqvuex.png"></a>
                        <button on:click={handleUserProfile} class="svg">
                            <span class="na-menu">
                                <Icon src={CgMenuCheese}  size="18" color="rgba(153, 164, 176, 0.6)" />
                            </span>
