<script>
  ...
  {#if chat.vip_level === 0}
  <div class="sc-khQegj fPtvsS {styleEL} levelnums_0">
  ...
  <div class="sc-khQegj fPtvsS {styleEL} levelnums_2">
    <img
      class="img-star"
      alt="level-star"
  ...
  <div class="sc-khQegj fPtvsS {styleEL} levelnums_2">
    ...
    <img
      ...
      src="https://static.nanogames.io/assets/p.47604fa2.png"
    />
    <img class="img-star" alt="level-star"
      src="https://static.nanogames.io/assets/p.47604fa2.png"
    />
    <img class="img-star" alt="level-star"
      src="data:image/png;base64,"
