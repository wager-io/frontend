            ...
            <div class="fast-btns">
                {#each $coin_list as iu  }
                    {#if iu.coin_name === "BTC" || iu.coin_name === "ETH"}
                        <button on:click={handleNetworks_isOpen}   class={`ui-button button-normal ${ active_coin.coin_name === iu.coin_name && "active" }  notranslate`}>
                            <div class="button-inner">
                                <img class="coin-icon" alt="" src={iu.coin_image}>
                                {iu.coin_name}
                            </div>
                        </button>
                    {/if}
        ...
        <div class="page-margin">
            <div class="s1d505hu">
                <div>
                    ...
                    <b class="amount">0.000500</b>
                    {:else}
                    <b class="amount">0.0002500</b>
                    {/if}{active_coin.coin_name}
                    <span> deposit</span>
                </div>
                <div class="btn">
                    <!-- <Icon src={RiSystemArrowRightSLine}  size="18"  color="rgb(255, 255, 255)"   /> -->
