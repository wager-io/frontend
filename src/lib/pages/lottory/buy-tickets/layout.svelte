  ...
  >
    ...
    <div class="dialog-body default-style" style="z-index: 2; transform: none;">
      <div class="sc-dkPtRN jScFby scroll-view sc-bXdNzS jybDrO">
        <div class="warn">
          <span
            >You can get more WGL from <a href="/wallet/swap?to=BCL">WAGER Swap</a> at
            anytime</span
          >
        </div>
        <div class="layout">
          ...
          <div
            class="error-txt {$default_Wallet.coin_name !== 'WGF'
              ? 'show'
              : ''}"
          >
            Please select WGF to buy a ticket!
          </div>
        </div>
            ...
            <div class="suff-desc">
              <div class="cont">
                ...
                <div style="font-size: .875rem" class="amount error">
                  {parseFloat(ticketCost).toFixed(8)} WGF
                </div>
              </div>
            </div>
          </div>
          <div class="desc">0.10000000 WGF/Ticket</div>
        </div>
