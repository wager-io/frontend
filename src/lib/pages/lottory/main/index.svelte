...
{#if !loading}
  <div class="sc-zjkyB jlxrhk {newScreen > 1000 ? "is_main" : "is_mobile"}" style="padding-left: {$is_open__Appp ? 55 : 15}px; padding-right: {$is_open__chat ? 366 : 10}px">
    ...
    <div class="sc-bhnkmi guxePV">
      ...
      <div class="sc-bjztik biQums lottery-subheader">
        <div class="cont sh">
          <div class="title">What Is <span>WGF</span>?</div>
          <div class="desc">
            WGL (WAGER Lottery) is a token created by WAGER.SERVICES for players who
            love the Lottery. You can use WGL to redeem lottery tickets in the
            Lottery at any time, 1 WGL = 1 lottery ticket.
          </div>
          <div class="btn">
            <button
              >Details
