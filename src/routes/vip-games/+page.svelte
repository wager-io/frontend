<script>
    import Home from "$lib/pages/vip/main/home.svelte";
    import { fly } from "svelte/transition";
    import { vipProfiile } from "$lib/pages/vip/vipstore";
  ...
  <div class="sc-hUplSX jzbUmw {$screen > 621 && $is_open__Appp ? `is-open` : ""} {$is_open__chat && `is-chat`}" >
      ...
      <div class="banner-head">
        ...
        <div class="vip-desc">
          ...
          <div class="vip-club-desc">
            ...
            players, WAGER.SERVICES invites you to join our VIP Club where
        ...
        <div class="card">
          <div class="card-cont">
            ...
            <div class="card-box box-p-bg">
              ...
              <div class="card-desc">
                WAGER.SERVICES respects and welcomes every distinguished VIP and
        ...
        <div class="card">
          <div class="card-cont">
            ...
            <div class="card-box box-p-bg">
              ...
              <div class="card-desc">
                WAGER.SERVICES offers many ways to get free coins to all our
    ...
    <div class="foot-desc">
      ...
      <div>- You all are WAGER.SERVICES. We wouldn't be here without you! -</div>
    </div>
  </div>
